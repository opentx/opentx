## JumperTX is firmware for the Jumper.xyz T12 Radio based on the OpenTX project and independantly maintained by Jumper.xyz. OpenTX are not affiliated with the JumperTX fork.
