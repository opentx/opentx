...
docker rm companion
cp binaries/*.deb $output/companion/linux/opentx-companion-linux-2.2.0$suffix.deb
...
wget -O companion-windows-2.2.0$suffix.exe http://winbox.open-tx.org/companion-builds/opentx-companion-windows-2.2.0$suffix.exe
