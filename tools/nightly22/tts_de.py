...
for s, f, a in [(u"Volt","volt", NO_ALTERNATE),  
             ...
             (u"MilliAmpere", "mamp", NO_ALTERNATE),
             (u"Knoten", "knot", NO_ALTERNATE),
             (u"Meter pro sekunde", "mps", NO_ALTERNATE),
             (u"Fuesse pro sekunde", "fps", NO_ALTERNATE),
             (u"kilometer pro stunde", "kph", NO_ALTERNATE),
             (u"Meilen pro Stunde", "mph", NO_ALTERNATE),
             (u"Meter", "meter", NO_ALTERNATE),
             (u"Fuesse", "foot", NO_ALTERNATE),
             (u"Grad", "celsius", NO_ALTERNATE),
             (u"Grad Fahrenheit", "fahr", NO_ALTERNATE),
             (u"Prozent", "percent", NO_ALTERNATE),
             ...
             (u"g", "g", NO_ALTERNATE),
             (u"degree", "degree", NO_ALTERNATE),
             (u"radians", "rad", NO_ALTERNATE),
             (u"Milliliter", "ml", NO_ALTERNATE),
             (u"Unze", "founce", NO_ALTERNATE),
             (u"Uhr", "hour", NO_ALTERNATE),
             (u"Minuten", "minute", NO_ALTERNATE),
             (u"Secunden", "second", NO_ALTERNATE),
             ]:
