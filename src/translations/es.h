...
#define LEN_VFSWFUNC     "\013"
  ...
  #define TR_FSW_BG_MUSIC  "BgMusica\0  ""BgMusica||\0"
...
#define TR_VFSWFUNC      "Seguro\0    ""Aprendiz\0  ""Inst. Trim\0" TR_SOUND TR_HAPTIC "Reset\0     " TR_VVARIO TR_PLAY_TRACK TR_PLAY_VALUE TR_SDCLOGS TR_FSW_VOLUME "Panel luz\0 " TR_FSW_BG_MUSIC TR_FSW_ADJUST_GVAR TR_FSW_TEST

#define LEN_VFSWRESET    TR("\006","\012")
#define TR_VFSWRESET     "Reloj 1  ""Reloj 2  ""Todo     ""Telemetr."
...
#define TR_VTELEMCHNS    "---\0""Tmr1""Tmr2""Tx\0 ""Rx\0 ""A1\0 ""A2\0 ""Alt\0""Rpm\0""Fuel""T1\0 ""T2\0 ""Spd\0""Dist""GAlt""Cell""Cels""Vfas""Curr""Cnsp""Powr""AccX""AccY""AccZ""Hdg\0""VSpd""A1-\0""A2-\0""Alt-""Alt+""Rpm+""T1+\0""T2+\0""Spd+""Dst+""Cur+""Acc\0""Hora"
...
#define TR_EXTRA_3POS_SWITCHES
  ...
  #define TR_VSWITCHES     "ACE""DIR""ELE""ID0""ID1""ID2" TR_EXTRA_3POS_SWITCHES "ALE""GEA""TRN""CS1""CS2""CS3""CS4""CS5""CS6""CS7""CS8""CS9""CSA""CSB""CSC""CSD""CSE""CSF""CSG""CSH""CSI""CSJ""CSK""CSL""CSM""CSN""CSO""CSP""CSQ""CSR""CSS""CST""CSU""CSV""CSW"" ON"
#else
  #define TR_VSWITCHES     "ACE""DIR""ELE""ID0""ID1""ID2" TR_EXTRA_3POS_SWITCHES "ALE""GEA""TRN""CS1""CS2""CS3""CS4""CS5""CS6""CS7""CS8""CS9""CSA""CSB""CSC"" ON"
#endif
...
#define TR_VSRCRAW       "Dir\0""Ele\0""Ace\0""Ale\0" TR_POTS_VSRCRAW TR_ROTARY_ENCODERS_VSRCRAW "TrmR" "TrmE" "TrmT" "TrmA" "MAX " TR_SW_VSRCRAW TR_CYC_VSRCRAW
