  ...
  ui(new Ui::SimulatedUIWidgetCommando8)
{
  ...
  addRadioWidget(ui->rightbuttons->addArea(QRect(25, 40, 35, 20), "Commando8/right-mdl.png", act));

  act = new RadioUiAction(6, QList<int>() << Qt::Key_Enter << Qt::Key_Return, SIMU_STR_HLP_KEYS_GO_UP, SIMU_STR_HLP_ACT_UP);
  addRadioWidget(ui->rightbuttons->addArea(QRect(25, 90, 35, 20), "Commando8/right-up.png", act));

  act = new RadioUiAction(7, QList<int>() << Qt::Key_Enter << Qt::Key_Return, SIMU_STR_HLP_KEYS_GO_DN, SIMU_STR_HLP_ACT_DN);
  addRadioWidget(ui->rightbuttons->addArea(QRect(25, 135, 35, 20), "Commando8/right-dn.png", act));

  act = new RadioUiAction(1, QList<int>() << Qt::Key_Enter << Qt::Key_Return, SIMU_STR_HLP_KEYS_ACTIVATE, SIMU_STR_HLP_ACT_ENT);
  addRadioWidget(ui->rightbuttons->addArea(QRect(25, 180, 35, 20), "Commando8/right-ent.png", act));

  act = new RadioUiAction(4, QList<int>() << Qt::Key_Left, SIMU_STR_HLP_KEY_LFT, SIMU_STR_HLP_ACT_SYS);
  addRadioWidget(ui->leftbuttons->addArea(QRect(60, 45, 35, 20), "Commando8/left-sys.png", act));
  ...
  addRadioWidget(ui->leftbuttons->addArea(QRect(60, 85, 35, 20), "Commando8/left-rtn.png", act));

  act = new RadioUiAction(3, QList<int>() << Qt::Key_PageDown, SIMU_STR_HLP_KEY_PGDN, SIMU_STR_HLP_ACT_PGDN);
  addRadioWidget(ui->leftbuttons->addArea(QRect(60, 135, 35, 20), "Commando8/left-pagedn.png", act));

  act = new RadioUiAction(2, QList<int>() << Qt::Key_PageUp, SIMU_STR_HLP_KEY_PGUP, SIMU_STR_HLP_ACT_PGUP);
  addRadioWidget(ui->leftbuttons->addArea(QRect(60, 180, 35, 20), "Commando8/left-pageup.png", act));
