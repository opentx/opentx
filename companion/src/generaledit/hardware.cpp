  ...
  ui(new Ui::Hardware)
{
  ...
  if (IS_TARANIS_X7(board) || IS_TARANIS_XLITE(board)|| IS_TARANIS_X9E(board) || IS_FAMILLY_HORUS_T16(board)) {
  ...
  if ((IS_FAMILLY_HORUS_T16(board) && board != Board::BOARD_X10_EXPRESS) || (IS_TARANIS_XLITE(board) && !IS_TARANIS_XLITES(board))) {
