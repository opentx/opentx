    ...
    switch(k) {
      ...
      case ITEM_MODEL_EXTERNAL_MODULE_MODE:
        ...
        if (IS_MODULE_XJT(EXTERNAL_MODULE))
          ...
          lcdDrawTextAtIndex(MODEL_SETUP_2ND_COLUMN+5*FW, y, STR_MULTI_PROTOCOLS, g_model.moduleData[EXTERNAL_MODULE].multi.rfProtocol, menuHorizontalPosition==1 ? attr : 0);
