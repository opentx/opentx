...
#endif
#if defined(HARDWARE_POT3) || defined(PCBX9D) || defined(RADIO_V10) // TODO #if defined(STORAGE_POT3)
  ITEM_RADIO_HARDWARE_POT3,
#endif
#if defined(HARDWARE_POT4) || defined(RADIO_V10)
...
#elif (NUM_POTS + NUM_SLIDERS) == 6
  #define POTS_ROWS               POTS_CALIBRATION NAVIGATION_LINE_BY_LINE|1, NAVIGATION_LINE_BY_LINE|1, NAVIGATION_LINE_BY_LINE|1, NAVIGATION_LINE_BY_LINE|1, NAVIGATION_LINE_BY_LINE|1, NAVIGATION_LINE_BY_LINE|1,
