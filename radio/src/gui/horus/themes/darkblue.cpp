...
class DarkblueTheme: public Theme
{
  public:
    ...
    void loadMenusIcons() const
    {
      ...
      loadMenuIcon(ICON_MONITOR_MIXERS1, "mask_monitor_outputs2.png");
      loadMenuIcon(ICON_MONITOR_MIXERS2, "mask_monitor_outputs2.png");
      loadMenuIcon(ICON_MONITOR_LOGIC_SWITCHES1, "mask_monitor_outputs1.png");
      loadMenuIcon(ICON_MONITOR_LOGIC_SWITCHES2, "mask_monitor_outputs1.png");
    }
