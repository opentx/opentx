...
class DefaultTheme: public Theme
{
  public:
    ...
    void loadIcons() const
    {
      ...
      loadMenuIcon(ICON_MONITOR_CHANNELS1, "mask_monitor_outputs1.png");
      loadMenuIcon(ICON_MONITOR_CHANNELS2, "mask_monitor_outputs2.png");
      loadMenuIcon(ICON_MONITOR_CHANNELS3, "mask_monitor_outputs3.png");
      loadMenuIcon(ICON_MONITOR_CHANNELS4, "mask_monitor_outputs4.png");
