...
#endif
#define TRAINER_CHANNELS_ROW             ((g_model.trainerMode == TRAINER_MODE_SLAVE || g_model.trainerMode == TRAINER_MODE_SLAVE_BLUETOOTH) ? (uint8_t)1 : HIDDEN_ROW)
#define TRAINER_PARAMS_ROW               ((g_model.trainerMode == TRAINER_MODE_SLAVE || g_model.trainerMode == TRAINER_MODE_SLAVE_BLUETOOTH) ? (uint8_t)2 : HIDDEN_ROW)
