...
inline uint8_t INTERNAL_MODULE_TYPE_ROW()
{
#if defined(INTERNAL_MODULE_PXX1)
  if(isModuleXJT(INTERNAL_MODULE) || isModulePXX2(INTERNAL_MODULE)) {
    return 1; // Module type + RF protocols
  }
#endif
...
#include "common/stdlcd/model_setup_pxx2.cpp"
  ...
  #define INTERNAL_MODULE_ROWS \
    LABEL(InternalModule), \
      ...
      IF_NOT_PXX2_MODULE(INTERNAL_MODULE, MODULE_OPTION_ROW(INTERNAL_MODULE)), \
      IF_NOT_ACCESS_MODULE_RF(INTERNAL_MODULE, MODULE_BIND_ROWS(INTERNAL_MODULE)), \
