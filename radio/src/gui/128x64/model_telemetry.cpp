...
#define IS_RANGE_DEFINED(k)            (g_model.frsky.channels[k].ratio > 0)
  ...
  #define TELEMETRY_TYPE_SHOW_TELEMETRY  (g_model.moduleData[INTERNAL_MODULE].type == MODULE_TYPE_NONE && g_model.moduleData[EXTERNAL_MODULE].type == MODULE_TYPE_PPM) ? (uint8_t)0 : HIDDEN_ROW
#elif defined (CPUARM)
