...
void menuStatisticsDebug(event_t event)
{
  ...
  lcdDrawText(lcdRightPos, MENU_DEBUG_Y_RTOS, "/");
  lcdDrawNumber(lcdRightPos, MENU_DEBUG_Y_RTOS+2, mixerStack.available(), UNSIGN|LEFT|TINSIZE);
  lcdDrawText(lcdRightPos, MENU_DEBUG_Y_RTOS, "/");
  lcdDrawNumber(lcdRightPos, MENU_DEBUG_Y_RTOS+2, audioStack.available(), UNSIGN|LEFT|TINSIZE);
#endif
