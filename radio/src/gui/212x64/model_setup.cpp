...
void menuModelSetup(event_t event)
{
  ...
  MENU_TAB({
    ...
    LABEL(InternalModule),
      ...
      IF_NOT_ACCESS_MODULE_RF(INTERNAL_MODULE, IF_INTERNAL_MODULE_ON(isModuleXJTD16(INTERNAL_MODULE) || isModuleXJTLR12(INTERNAL_MODULE)? (uint8_t)2 : (uint8_t)1)), // RxNum, Range check and Register buttons
