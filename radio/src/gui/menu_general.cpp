  ...
  for (uint8_t i=0; i<LCD_LINES-1; i++) {
    ...
    switch(k) {
      ...
      case ITEM_SETUP_VARIO_RANGE:
        ...
        if (attr) CHECK_INCDEC_GENVAR(event, g_eeGeneral.varioRange, -30, 30);
        break;
