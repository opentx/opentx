...
bool isModuleSynchronous(uint8_t moduleIdx)
{
  ...
  if (protocol == PROTOCOL_CHANNELS_PXX2_HIGHSPEED || protocol == PROTOCOL_CHANNELS_PXX2_LOWSPEED || protocol == PROTOCOL_CHANNELS_CROSSFIRE || protocol == PROTOCOL_CHANNELS_AFHDS3 || protocol == PROTOCOL_CHANNELS_NONE)
    return true;
