...
{
  uint32_t debugval;
  if (g_model.moduleData[EXTERNAL_MODULE].type == MODULE_TYPE_MULTI && g_model.moduleData[EXTERNAL_MODULE].getMultiProtocol(true) == MODULE_SUBTYPE_MULTI_DSM2
  ...
  if (g_model.moduleData[EXTERNAL_MODULE].type == MODULE_TYPE_MULTI && g_model.moduleData[EXTERNAL_MODULE].getMultiProtocol(true) == MODULE_SUBTYPE_MULTI_DSM2 && moduleState[EXTERNAL_MODULE].mode == MODULE_MODE_BIND) {
