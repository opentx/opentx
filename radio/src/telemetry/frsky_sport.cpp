...
const FrSkySportSensor sportSensors[] = {
  ...
  { 0x5100, 0x5100, 0, ZSTR_TADANGO_LINK, UNIT_PERCENT, 0 },
  { 0x5110, 0x5110, 0, ZSTR_TADANGO_GPS_DIST, UNIT_METERS, 0 },
  { 0x5120, 0x5120, 0, ZSTR_TADANGO_GPS_TRAV, UNIT_METERS, 0 },
  { 0x5130, 0x5130, 0, ZSTR_TADANGO_RX1E, UNIT_RAW, 0 },
  { 0x5140, 0x5140, 0, ZSTR_TADANGO_RX2E, UNIT_RAW, 0 },
  { 0x5150, 0x5150, 0, ZSTR_TADANGO_RXFL, UNIT_RAW, 0 },
  { 0x5160, 0x5160, 0, ZSTR_TADANGO_RXHO, UNIT_RAW, 0 },
