...
void telemetryReset()
{
  ...
  setTelemetryValue(TELEM_PROTO_FRSKY_SPORT, T1_FIRST_ID, 6, 100, UNIT_CELSIUS, 0);
  setTelemetryValue(TELEM_PROTO_FRSKY_SPORT, T1_FIRST_ID+1, 6, 200, UNIT_CELSIUS, 0);
