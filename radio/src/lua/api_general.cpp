...
// Virtual events
  ...
  { "EVT_VIRTUAL_DEC", EVT_KEY_FIRST(KEY_UP) },
  { "EVT_VIRTUAL_DEC_REPT", EVT_KEY_REPT(KEY_UP) },
  { "EVT_VIRTUAL_INC", EVT_KEY_FIRST(KEY_DOWN) },
  { "EVT_VIRTUAL_INC_REPT", EVT_KEY_REPT(KEY_DOWN) },
#endif
