...
#if defined(COLORLCD)
  //Menu icons here
  {"ICON_OPENTX", (double)ICON_OPENTX },
  {"ICON_RADIO", (double)ICON_RADIO },
  {"ICON_RADIO_SETUP", (double)ICON_RADIO_SETUP },
  {"ICON_RADIO_SD_BROWSER", (double)ICON_RADIO_SD_BROWSER },
  {"ICON_RADIO_GLOBAL_FUNCTIONS", (double)ICON_RADIO_GLOBAL_FUNCTIONS },
  {"ICON_RADIO_TRAINER", (double)ICON_RADIO_TRAINER },
  {"ICON_RADIO_HARDWARE", (double)ICON_RADIO_HARDWARE },
  {"ICON_RADIO_CALIBRATION", (double)ICON_RADIO_CALIBRATION },
  {"ICON_RADIO_VERSION", (double)ICON_RADIO_VERSION },
  {"ICON_MODEL", (double)ICON_MODEL },
  {"ICON_MODEL_SETUP", (double)ICON_MODEL_SETUP },
  {"ICON_MODEL_HELI", (double)ICON_MODEL_HELI },
  {"ICON_MODEL_FLIGHT_MODES", (double)ICON_MODEL_FLIGHT_MODES },
  {"ICON_MODEL_INPUTS", (double)ICON_MODEL_INPUTS },
  {"ICON_MODEL_MIXER", (double)ICON_MODEL_MIXER },
  {"ICON_MODEL_OUTPUTS", (double)ICON_MODEL_OUTPUTS },
  {"ICON_MODEL_CURVES", (double)ICON_MODEL_CURVES },
  {"ICON_MODEL_GVARS", (double)ICON_MODEL_GVARS },
  {"ICON_MODEL_LOGICAL_SWITCHES", (double)ICON_MODEL_LOGICAL_SWITCHES },
  {"ICON_MODEL_SPECIAL_FUNCTIONS", (double)ICON_MODEL_SPECIAL_FUNCTIONS },
  {"ICON_MODEL_LUA_SCRIPTS", (double)ICON_MODEL_LUA_SCRIPTS },
  {"ICON_MODEL_TELEMETRY", (double)ICON_MODEL_TELEMETRY },
  {"ICON_THEME", (double)ICON_THEME },
  {"ICON_THEME_SETUP", (double)ICON_THEME_SETUP },
  {"ICON_THEME_VIEW1", (double)ICON_THEME_VIEW1 },
  {"ICON_THEME_VIEW2", (double)ICON_THEME_VIEW2 },
  {"ICON_THEME_VIEW3", (double)ICON_THEME_VIEW3 },
  {"ICON_THEME_VIEW4", (double)ICON_THEME_VIEW4 },
  {"ICON_THEME_VIEW5", (double)ICON_THEME_VIEW5 },
  {"ICON_THEME_ADD_VIEW", (double)ICON_THEME_ADD_VIEW },
  {"ICON_STATS", (double)ICON_STATS },
  {"ICON_STATS_THROTTLE_GRAPH", (double)ICON_STATS_THROTTLE_GRAPH },
  {"ICON_STATS_TIMERS", (double)ICON_STATS_TIMERS },
  {"ICON_STATS_ANALOGS", (double)ICON_STATS_ANALOGS },
  {"ICON_STATS_DEBUG", (double)ICON_STATS_DEBUG },
  {"ICON_MONITOR", (double)ICON_MONITOR },
  {"ICON_MONITOR_CHANNELS1", (double)ICON_MONITOR_CHANNELS1 },
  {"ICON_MONITOR_CHANNELS2", (double)ICON_MONITOR_CHANNELS2 },
  {"ICON_MONITOR_CHANNELS3", (double)ICON_MONITOR_CHANNELS3 },
  {"ICON_MONITOR_CHANNELS4", (double)ICON_MONITOR_CHANNELS4 },
  {"ICON_MONITOR_LOGICAL_SWITCHES", (double)ICON_MONITOR_LOGICAL_SWITCHES },
