...
enum PolishPrompts {
  ...
  PL_PROMPT_TYSIACE = PL_PROMPT_NUMBERS_BASE+110,		// TYSIĄCE
  PL_PROMPT_TYSIECY = PL_PROMPT_NUMBERS_BASE+111,		// TYSIĘCY
  PL_PROMPT_JEDNA = PL_PROMPT_NUMBERS_BASE+112,			// JEDNA
  //PL_PROMPT_JEDNO = PL_PROMPT_NUMBERS_BASE+113,		// JEDNO
  PL_PROMPT_DWIE = PL_PROMPT_NUMBERS_BASE+114,			// DWIE
  //PL_PROMPT_CALA = PL_PROMPT_NUMBERS_BASE+115,		// CAŁA
  //PL_PROMPT_CALE = PL_PROMPT_NUMBERS_BASE+116,		// CAŁE
  //PL_PROMPT_CALYCH = PL_PROMPT_NUMBERS_BASE+117,		// CAŁYCH
  PL_PROMPT_MINUS = PL_PROMPT_NUMBERS_BASE+118,			// MINUS

  PL_PROMPT_PRZECINEK = PL_PROMPT_NUMBERS_BASE+119,		// PRZECINEK
...
I18N_PLAY_FUNCTION(pl, playNumber, getvalue_t number, uint8_t unit, uint8_t att)
{
  ...
  if (mode > 0) {
    ...
    if (qr.rem) {			//jeżeli występuje reszta z dzielenia
...
// === DZIESIĄTKI ŻEŃSKIE (22,23,23,32,33,33 ...) ===
  if (number >= 0) {
    int test_2 =0;
    test_2 =number % 10;
    int ten=0;
