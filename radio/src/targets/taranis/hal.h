...
#define EXTMODULE_PULSES
  ...
  #define EXTMODULE_RCC_APB2Periph      (RCC_APB2Periph_TIM8 | RCC_APB2Periph_USART6)
    ...
    #define EXTERNAL_MODULE_PWR_ON()      GPIO_ResetBits(EXTMODULE_PWR_GPIO, EXTMODULE_PWR_GPIO_PIN)
    #define EXTERNAL_MODULE_PWR_OFF()     GPIO_SetBits(EXTMODULE_PWR_GPIO, EXTMODULE_PWR_GPIO_PIN)
