...
#define ADC_SAMPTIME                    2   // sample time = 28 cycles
  ...
  #define ADC_CHANNEL_STICK_RV          ADC_Channel_3  // ADC1_IN0
  #define ADC_CHANNEL_STICK_RH          ADC_Channel_2  // ADC1_IN1
  #define ADC_CHANNEL_STICK_LV          ADC_Channel_0  // ADC1_IN2
