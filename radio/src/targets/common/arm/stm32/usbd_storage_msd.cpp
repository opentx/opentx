...
const char g_FATboot[BLOCK_SIZE] =
{
  ...
  0x02, 0x00, // Reserved sector count
...
#if defined(EEPROM) && (EEPROM_SIZE==(32*1024) && FLASHSIZE == (512*1024))
const char g_FAT[2*BLOCK_SIZE] =
  {
    ...
    0x81, 0xF0, 0xFF, 0x83, 0x40, 0x08, 0x85, 0x60, 0x08, 0x87, 0x80, 0x08, 0x89, 0xF0, 0xFF, 0x00,
    0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
    // Last value of array (0x00) is repeated to fill the array (as per C++)
  };
#elif !defined(EEPROM) && (FLASHSIZE==2048*1024)
const char g_FAT[2*BLOCK_SIZE] =
  {
    0xF8, 0xFF, 0xFF, 0x03, 0x40, 0x00, 0x05, 0x60, 0x00, 0x07, 0x80, 0x00, 0x09, 0xA0, 0x00, 0x0B,
    0xC0, 0x00, 0x0D, 0xE0, 0x00, 0x0F, 0x00, 0x01, 0x11, 0x20, 0x01, 0x13, 0x40, 0x01, 0x15, 0x60,
    ...
    0x01, 0x21, 0x10, 0x03, 0x41, 0x10, 0x05, 0x61, 0x10, 0x07, 0x81, 0x10, 0x09, 0xA1, 0x10, 0x0B,
    0xC1, 0x10, 0x0D, 0xE1, 0x10, 0x0F, 0x01, 0x11, 0x11, 0x21, 0x11, 0x13, 0x41, 0x11, 0x15, 0x61,
    0x11, 0x17, 0x81, 0x11, 0x19, 0xA1, 0x11, 0x1B, 0xC1, 0x11, 0x1D, 0xE1, 0x11, 0x1F, 0x01, 0x12,
    ...
    
    // Last value of array (0x00) is repeated to fill the array (as per C++)
  };
#else
#error No FAT12 for EEPROM/FLASH combination
#endif
//	File Attributes
//	0 	0x01 	Read Only.
//	1 	0x02 	Hidden.
...
int32_t fat12Read(uint8_t * buffer, uint16_t sector, uint16_t count)
{
  while(count) {
    ...
    else if (sector == 2/*Reserved sector count*/) {
      // FAT table.
      memcpy(buffer, g_FAT + BLOCK_SIZE, BLOCK_SIZE);
    }
    else if (sector == 3) {
