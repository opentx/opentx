...
/// Pins ADC
#define PINS_ADC                                                                                                       \
  PIN_ADC0_AD0, PIN_ADC0_AD1, PIN_ADC0_AD2, PIN_ADC0_AD3, PIN_ADC0_AD4, PIN_ADC0_AD5, PIN_ADC0_AD6, PIN_ADC0_AD7
...
#define PINS_MCI                                                                                                       \
  {                                                                                                                    \
    0x3fUL << 26, PIOA, ID_PIOA, PIO_PERIPH_C, PIO_PULLUP                                                              \
  }
/** MCI pin Card Detect. */
#define PIN_MCI_CD                                                                                                     \
  {                                                                                                                    \
    PIO_PB7, PIOB, ID_PIOB, PIO_INPUT, PIO_PULLUP                                                                      \
  }
...
#define SD_CSD_C_SIZE(pSd)                                                                                             \
  ((SD_CSD(pSd, 72, 2) << 10) + (SD_CSD(pSd, 64, 8) << 2) + SD_CSD(pSd, 62, 2)) ///< Device size

#define SD_CSD_C_SIZE_HC(csd)                                                                                          \
  ((SD_CSD(csd, 64, 6) << 16) + (SD_CSD(csd, 56, 8) << 8) + SD_CSD(csd, 48, 8)) ///< Device size v2.0 High Capacity
...
#define PINS_NANDFLASH                                                                                                 \
  PIN_EBI_NANDIO, BOARD_NF_CE_PIN, BOARD_NF_RB_PIN, PIN_EBI_NANDOE, PIN_EBI_NANDWE, PIN_EBI_NANDCLE, PIN_EBI_NANDALE
