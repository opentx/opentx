...
#define TPRST_LOW()                                                                                                    \
  do {                                                                                                                 \
    TOUCH_RST_GPIO->BSRRH = TOUCH_RST_GPIO_PIN;                                                                        \
  } while (0)
#define TPRST_HIGH()                                                                                                   \
  do {                                                                                                                 \
    TOUCH_RST_GPIO->BSRRL = TOUCH_RST_GPIO_PIN;                                                                        \
  } while (0)

#define TPINT_LOW()                                                                                                    \
  do {                                                                                                                 \
    TOUCH_INT_GPIO->BSRRH = TOUCH_INT_GPIO_PIN;                                                                        \
  } while (0)
#define TPINT_HIGH()                                                                                                   \
  do {                                                                                                                 \
    TOUCH_INT_GPIO->BSRRL = TOUCH_INT_GPIO_PIN;                                                                        \
  } while (0)
