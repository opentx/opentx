...
#define AUX2_DEBUG_PIN1_HIGH()      GPIO_SetBits(AUX2_DEBUG_GPIO1, AUX2_DEBUG_PIN1);
#define AUX2_DEBUG_PIN1_LOW()       GPIO_ResetBits(AUX2_DEBUG_GPIO1, AUX2_DEBUG_PIN1);
#define AUX2_DEBUG_PIN2_HIGH()      GPIO_SetBits(AUX2_DEBUG_GPIO2, AUX2_DEBUG_PIN2);
#define AUX2_DEBUG_PIN2_LOW()       GPIO_ResetBits(AUX2_DEBUG_GPIO2, AUX2_DEBUG_PIN2);
#define AUX2_DEBUG_PIN3_HIGH()      GPIO_SetBits(AUX2_DEBUG_GPIO3, AUX2_DEBUG_PIN3);
#define AUX2_DEBUG_PIN3_LOW()       GPIO_ResetBits(AUX2_DEBUG_GPIO3, AUX2_DEBUG_PIN3);
#define AUX2_DEBUG_PIN4_HIGH()      GPIO_SetBits(AUX2_DEBUG_GPIO4, AUX2_DEBUG_PIN4);
#define AUX2_DEBUG_PIN4_LOW()       GPIO_ResetBits(AUX2_DEBUG_GPIO4, AUX2_DEBUG_PIN4);
void aux2DebugInit();
#endif
