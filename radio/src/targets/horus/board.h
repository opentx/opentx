...
enum EnumSwitches { SW_SA, SW_SB, SW_SC, SW_SD, SW_SE, SW_SF, SW_SG, SW_SH, SW_SI, SW_SJ, NUM_SWITCHES };
...
#define DBLKEYS_PRESSED_RGT_LFT(in)                                                                                    \
  ((in & ((1 << KEY_RIGHT) + (1 << KEY_LEFT))) == ((1 << KEY_RIGHT) + (1 << KEY_LEFT)))
...
void DMAFillRect(uint16_t *dest, uint16_t destw, uint16_t desth, uint16_t x, uint16_t y, uint16_t w, uint16_t h,
                 uint16_t color);
void DMACopyBitmap(uint16_t *dest, uint16_t destw, uint16_t desth, uint16_t x, uint16_t y, const uint16_t *src,
                   uint16_t srcw, uint16_t srch, uint16_t srcx, uint16_t srcy, uint16_t w, uint16_t h);
void DMACopyAlphaBitmap(uint16_t *dest, uint16_t destw, uint16_t desth, uint16_t x, uint16_t y, const uint16_t *src,
                        uint16_t srcw, uint16_t srch, uint16_t srcx, uint16_t srcy, uint16_t w, uint16_t h);
...
#define BACKLIGHT_ENABLE()                                                                                             \
  backlightEnable(globalData.unexpectedShutdown ? BACKLIGHT_LEVEL_MAX : BACKLIGHT_LEVEL_MAX - currentBacklightBright)
