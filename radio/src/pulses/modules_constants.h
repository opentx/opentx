...
enum ExternalAntennaModes {
  EXTERNAL_ANTENNA_DISABLE = -2,
  EXTERNAL_ANTENNA_ASK = -1,
  EXTERNAL_ANTENNA_PER_MODEL = 0,
  EXTERNAL_ANTENNA_ENABLE = 1,
  EXTERNAL_ANTENNA_FIRST = EXTERNAL_ANTENNA_DISABLE,
  EXTERNAL_ANTENNA_LAST = EXTERNAL_ANTENNA_ENABLE
};
