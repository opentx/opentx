...
enum ModuleSubtypePXX2 {
  MODULE_SUBTYPE_PXX2_ACCESS,
  MODULE_SUBTYPE_PXX2_ACCST_D16,
  MODULE_SUBTYPE_PXX2_ACCST_LR12,
  MODULE_SUBTYPE_PXX2_LAST = MODULE_SUBTYPE_PXX2_ACCST_LR12
};
