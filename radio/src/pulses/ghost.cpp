...
uint8_t createGhostChannelsFrame(uint8_t * frame, int16_t * pulses)
{
  ...
  {
    case GHST_UL_RC_CHANS_HS4_5TO8:     ghostUpper4Offset = 0;      break;
    case GHST_UL_RC_CHANS_HS4_9TO12:    ghostUpper4Offset = 4;      break;
    case GHST_UL_RC_CHANS_HS4_13TO16:   ghostUpper4Offset = 8;      break;
  }
  ...
  *buf++ = crc8(crc_start, GHST_UL_RC_CHANS_SIZE - 1);
  ...
  switch(lastGhostFrameId)
  {
    case GHST_UL_RC_CHANS_HS4_5TO8:     lastGhostFrameId =GHST_UL_RC_CHANS_HS4_9TO12;     break;
    case GHST_UL_RC_CHANS_HS4_9TO12:    lastGhostFrameId =GHST_UL_RC_CHANS_HS4_13TO16;    break;
    case GHST_UL_RC_CHANS_HS4_13TO16:   lastGhostFrameId =GHST_UL_RC_CHANS_HS4_5TO8;      break;
  }
