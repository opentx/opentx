...
#if defined(MULTI)
  #define IS_MULTI_PROTOCOL(protocol)  (protocol==PROTOCOL_CHANNELS_MULTI)
  #if !defined(DSM2)
     #error You need to enable DSM2 = PPM for MULTI support
  #endif
#else
  #define IS_MULTI_PROTOCOL(protocol)  (0)
#endif
...
#define MULTI_BAUDRATE         100000
#define MULTI_PERIOD           7 /*ms*/
...
#if defined(MULTI) //&& defined(INTMODULE_USART)
...
#if defined(DSM2) || defined(MULTI) || defined(SBUS)
  Dsm2PulsesData dsm2;
#endif
