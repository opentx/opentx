...
static const struct YamlNode struct_RadioData[] = {
  ...
  YAML_ARRAY( "switchConfig", 2, 16, struct_switchConfig, NULL),
  YAML_ARRAY( "potsConfig", 2, 8, struct_potConfig, NULL ),
  YAML_ARRAY( "slidersConfig", 1, 8, struct_sliderConfig, NULL ),
