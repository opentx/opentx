//This file was auto-generated by generate_datacopy.py script on Mon Sep 24 19:47:57 2018. Do not edit this file!
...
void copyRadioData(A * dest, B * src)
{
  ...
  dest->reNavigation = src->reNavigation;
  dest->stickReverse = src->stickReverse;
  for (int i=0; i<64; i++) {
    copyCustomFunctionData(&dest->customFn[i], &src->customFn[i]);
  }
...
template <class A, class B>
void copyModuleData_flysky(A * dest, B * src)
{
  memcpy(dest->rx_id, src->rx_id, sizeof(dest->rx_id));
  dest->mode = src->mode;
  memcpy(dest->rx_freq, src->rx_freq, sizeof(dest->rx_freq));
}
