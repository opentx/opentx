//This file was auto-generated by generate_datacopy.py script on Tue Mar 19 19:58:50 2019. Do not edit this file!
...
void copyModuleData(A * dest, B * src)
{
  ...
  dest->channelsStart = src->channelsStart;
  dest->channelsCount = src->channelsCount;
  copyModuleData_r9m(&dest->r9m, &src->r9m);
...
void copyModelData(A * dest, B * src)
{
  ...
  for (int i=0; i<10; i++) {
    copyReceiverData(&dest->receiverData[i], &src->receiverData[i]);
  }
...
template <class A, class B>
void copyModuleData_r9m(A * dest, B * src)
{
