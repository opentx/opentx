...
const pm_char STR_BACKUP[] PROGMEM = TR_BACKUP;
...
#if defined(SDCARD)
const pm_char STR_RESTORE_RADIO[] PROGMEM = TR_RESTORE_RADIO;
...
const pm_char STR_BLCOLOR[]  PROGMEM = TR_BLCOLOR;
  ...
  const pm_char STR_BINDING_OPTION[] PROGMEM = TR_BINDING_OPTION;
