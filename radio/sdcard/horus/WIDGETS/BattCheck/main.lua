...
---- #      LI-xx BATTCHECK v1 // Use it with OpenTX 2.2.x         #
---- #                                                             #
---- #  License: Share alike                                       #
---- #  Can be used and changed non commercial                     #
---- #                                                             #
---- #  Developed for Horus widgets by OpenTx team.                #
---- #  Initial work for Taranis by Heisenberg.                    #
---- #                                                             #
---- #  Credits to Kilrah, Dev.Fred, and Sacred100                 #
...
function refresh(myZone)
	if myZone.zone.w  == 160 then zoneSmall(myZone)
	elseif myZone.zone.w  == 180 then zoneMedium(myZone)
	elseif myZone.zone.w  == 192 then zoneLarge(myZone)
	elseif myZone.zone.w  == 390 then zoneXLarge(myZone)
	end
end
