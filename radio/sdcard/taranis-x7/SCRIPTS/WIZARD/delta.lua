...
local function drawEngineMenu()
  ...
  lcd.drawText(108, 0, " 1/3", 0)
  lcd.drawText(5, 49, " Engine-Ch:", 0)
...
local function drawElevonsMenu()
  lcd.clear()
  lcd.drawText(1, 0, "Elevons Setup", 0)
  lcd.drawText(108, 0, " 2/3", 0)
  lcd.drawText(5, 49, "Ele-Ch R/L:", 0)
  --lcd.drawFilledRectangle(0, 0, LCD_W, 8, GREY_DEFAULT+FILL_WHITE)
  lcd.drawCombobox(0, 8, LCD_W/2, elevonsModeItems, elevonsMode, 0)
  lcd.drawLine(LCD_W/2-1, 18, LCD_W/2-1, LCD_H-1, DOTTED, 0)
  lcd.drawText(75, 8, "Elevons")
  lcd.drawText(20, LCD_H-25, "Assign channels", 0);
  --lcd.drawText(LCD_W/2-19, LCD_H-8, ">>>", 0);
  lcd.drawSource(68, LCD_H-15, MIXSRC_CH1+elevCH1, getFieldFlags(0))
  lcd.drawSource(90, LCD_H-15, MIXSRC_CH1+elevCH2, getFieldFlags(1))
  fieldsMax = 1
end
...
local function drawRudderMenu()
  lcd.clear()
  lcd.drawText(1, 0, "Rudder Setup", 0)
  lcd.drawText(108, 0, " 3/3", 0)
  ...
  if rudderMode == 0 then
    -- No rudder
    lcd.drawText(75, 8, "Rudder-0")
    fieldsMax = 0
  else
    -- 1 channel
    lcd.drawText(75, 8, "Rudder-1")
    lcd.drawText(25, LCD_H-25, "Assign channel", 0);
    --lcd.drawText(LCD_W/2-19, LCD_H-8, ">>>", 0);
    lcd.drawSource(68, LCD_H-15, MIXSRC_CH1+rudCH1, getFieldFlags(1))
    fieldsMax = 1
  end
end
