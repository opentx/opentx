...
local function drawThrottleMenu()
  lcd.clear()
  lcd.drawText(1, 0, "multi thr ch", 0)
  lcd.drawText(108, 0, " 1/4", 0)
  --lcd.drawText(5, 49, " Rud-Ch:", 0)
 -- lcd.drawFilledRectangle(0, 0, LCD_W, 8, GREY_DEFAULT+FILL_WHITE)
  ...
  lcd.drawText(75, 8, "multi-thr")
  lcd.drawText(20, LCD_H-35, "Assign Throttle", 0);
  lcd.drawText(20, LCD_H-25, "Channel", 0);
  --lcd.drawText(LCD_W/2-19, LCD_H-8, ">>>", 0);
  lcd.drawSource(68, LCD_H-15, MIXSRC_CH1+thrCH1, getFieldFlags(0))
  fieldsMax = 0
end
...
local function drawRollMenu()
  lcd.clear()
  lcd.drawText(1, 0, "multi roll ch", 0)
  lcd.drawText(108, 0, " 2/4", 0)
  --lcd.drawText(5, 49, " Rud-Ch:", 0)
  --lcd.drawFilledRectangle(0, 0, LCD_W, 8, GREY_DEFAULT+FILL_WHITE)
  lcd.drawCombobox(0, 8, LCD_W/2, {"..."}, comboBoxMode, getFieldFlags(1))
  lcd.drawLine(LCD_W/2-1, 18, LCD_W/2-1, LCD_H-1, DOTTED, 0)
  lcd.drawText(74, 8, "multi-roll")
  lcd.drawText(20, LCD_H-35, "Assign Roll", 0);
  lcd.drawText(20, LCD_H-25, "Channel", 0);
  --lcd.drawText(LCD_W/2-19, LCD_H-8, ">>>", 0);
  lcd.drawSource(68, LCD_H-15, MIXSRC_CH1+rollCH1, getFieldFlags(0))
  fieldsMax = 0
end
...
local function drawPitchMenu()
  lcd.clear()
  lcd.drawText(1, 0, "multi pitch ch", 0)
  lcd.drawText(108, 0, " 3/4", 0)
  --lcd.drawText(5, 49, " Rud-Ch:", 0)
  --lcd.drawFilledRectangle(0, 0, LCD_W, 8, GREY_DEFAULT+FILL_WHITE)
  lcd.drawCombobox(0, 8, LCD_W/2, {"..."}, comboBoxMode, getFieldFlags(1))
  lcd.drawLine(LCD_W/2-1, 18, LCD_W/2-1, LCD_H-1, DOTTED, 0)
  lcd.drawText(74, 8, "multi-pitch")
  lcd.drawText(20, LCD_H-35, "Assign Pitch", 0);
  lcd.drawText(20, LCD_H-25, "Channel", 0);
  --lcd.drawText(LCD_W/2-19, LCD_H-8, ">>>", 0);
  lcd.drawSource(68, LCD_H-15, MIXSRC_CH1+pitchCH1, getFieldFlags(0))
  fieldsMax = 0
end
...
local function drawYawMenu()
  lcd.clear()
  lcd.drawText(1, 0, "multi yaw ch", 0)
  lcd.drawText(108, 0, " 4/4", 0)
  --lcd.drawText(5, 49, " Rud-Ch:", 0)
 -- lcd.drawFilledRectangle(0, 0, LCD_W, 8, GREY_DEFAULT+FILL_WHITE)
  lcd.drawCombobox(0, 8, LCD_W/2, {"..."}, comboBoxMode, getFieldFlags(1))
  lcd.drawLine(LCD_W/2-1, 18, LCD_W/2-1, LCD_H-1, DOTTED, 0)
  lcd.drawText(74, 8, "multi-yaw")
  lcd.drawText(20, LCD_H-35, "Assign Yaw", 0);
  lcd.drawText(20, LCD_H-25, "Channel", 0);
  --lcd.drawText(LCD_W/2-19, LCD_H-8, ">>>", 0);
  lcd.drawSource(68, LCD_H-15, MIXSRC_CH1+yawCH1, getFieldFlags(0))
  fieldsMax = 0
end
...
local function drawConfirmationMenu()
  ...
  lcd.drawText(LCD_W-18, 0, "confirm-tick.bmp")
  lcd.drawText(0, LCD_H-17, "confirm-plane.bmp")
  fieldsMax = 0
end
