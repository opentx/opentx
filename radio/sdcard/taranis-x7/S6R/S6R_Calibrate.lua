...
local function drawCalibrationOrientation(x, y, step)
    local orientation = { {"Label face up,", "Pins Right"},
                            {"Label face down,", "Pins Right"},
                            {"Label face front,", "Pins Up"},
                            {"Label face front,", "Pins Down"},
                            {"Label face front,", "Pins Right"},
                            {"Label face front,", "Pins Left"} }
    ...
    for index = 1, 3, 1 do
      ...
      lcd.drawText(100, 12+10*index, field[1], 0)
      lcd.drawNumber(110, 12+10*index, field[4]/10, LEFT+PREC2)
    end                  
end
