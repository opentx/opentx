...
for s, f, a in [(u"volt", "volt", NO_ALTERNATE),
                ...
                (u"piede al secondo", "fps", NO_ALTERNATE), ("piedi al secondo", "feetps", NO_ALTERNATE),
                ...
                (u"grado celsius", "celsius", NO_ALTERNATE), ("gradi celsius", "degsc", NO_ALTERNATE),
                (u"grado fahrenheit", "fahr", NO_ALTERNATE), ("gradi fahrenheit", "degsf", NO_ALTERNATE),
                ...
                (u"millilitro", "m1", NO_ALTERNATE), ("millilitri", "mms", NO_ALTERNATE),
