...
for i, (s, f) in enumerate([(u"volts", "volt0"),
                            ...
                            (u"chilometro ora", "kph0"), ("chilometri orari", "kph1"),
                            ...
                            (u"milliampèr? ora", "mamph0"), (u"milliampèr? ora", "mamph1"),
                            (u"watt", "watt0"), (u"watt", "watt1"),
                            (u"milli-watt", "mwatt0"), ("milli-watt", "mwatt1"),
                            (u"d b", "db0"), (u"d b", "db1"),
...
for s, f, a in [(u"radio inattiva controllare", "inactiv", 486),
                ...
                (u"formattazzione eeprom in corso", "eeformat", NO_ALTERNATE),
