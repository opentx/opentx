...
for s, f, a in [(u"volt", "volt0", NO_ALTERNATE),
                ...
                (u"nodo", "knot0", NO_ALTERNATE), ("nodi", "knots", NO_ALTERNATE),
                (u"metro al secondo", "mps0", NO_ALTERNATE), ("metri al secondo", "msps", NO_ALTERNATE),
                (u"piede al secondo", "fps0", NO_ALTERNATE), ("piedi al secondo", "feetps", NO_ALTERNATE),
                (u"chilometro ora", "kph0", NO_ALTERNATE), ("kilometers per hour", "ksph", NO_ALTERNATE),
                (u"miglio per ora", "mph0", NO_ALTERNATE), ("miglia per ora", "msph", NO_ALTERNATE),
                (u"metro", "meter0", NO_ALTERNATE), ("metri", "meters", NO_ALTERNATE),
                (u"piede", "foot0", NO_ALTERNATE), ("piedi", "feet", NO_ALTERNATE),
                (u"grado celsius", "celsius0", NO_ALTERNATE), ("gradi celsius", "degsc", NO_ALTERNATE),
                (u"grado fahrenheit", "fahr0", NO_ALTERNATE), ("gradi fahrenheit", "degsf", NO_ALTERNATE),
                (u"percento", "percent0", NO_ALTERNATE),
                (u"milliampere ora", "mamph0", NO_ALTERNATE),
                (u"watt", "watt0", NO_ALTERNATE),
                (u"milli-watt", "mwatt0", NO_ALTERNATE), ("milli-watts", "mwatts", NO_ALTERNATE),
                (u"db", "db0", NO_ALTERNATE),
                (u"r p m", "rpm0", NO_ALTERNATE),
                (u"g", "g0", NO_ALTERNATE),
                (u"grado", "degree0", NO_ALTERNATE), ("gradi", "degrees", NO_ALTERNATE),
                (u"radian", "rad0", NO_ALTERNATE), ("radians", "rads", NO_ALTERNATE),
                (u"millilitro", "m10", NO_ALTERNATE), ("millilitri", "mms", NO_ALTERNATE),
                (u"oncia", "founce0", NO_ALTERNATE), ("once", "founces", NO_ALTERNATE),
                (u"hour", "hour0", NO_ALTERNATE), ("hours", "hours", NO_ALTERNATE),
                (u"minute", "minute0", NO_ALTERNATE), ("minutes", "minutes", NO_ALTERNATE),
                (u"second", "second0", NO_ALTERNATE), ("seconds", "seconds", NO_ALTERNATE),
                       ]:
