...
for s, f, a in [("volt", "volt", NO_ALTERNATE), ("volts", "volts", NO_ALTERNATE),
                ("amp", "amp", NO_ALTERNATE), ("amps", "amps", NO_ALTERNATE),
                ("milliamp", "mamp", NO_ALTERNATE), ("milliamps", "mamps", NO_ALTERNATE),
                ("knot", "knot", NO_ALTERNATE), ("knots", "knots", NO_ALTERNATE),
                ("meter per second", "mps", NO_ALTERNATE), ("meters per second", "msps", NO_ALTERNATE),
                ("foot per second", "footps", NO_ALTERNATE), ("feet per second", "feetps", NO_ALTERNATE),
                ("kilometer per hour", "kph", NO_ALTERNATE), ("kilometers per hour", "ksph", NO_ALTERNATE),
                ("mile per hour", "mph", NO_ALTERNATE), ("miles per hour", "msph", NO_ALTERNATE),
                ("meter", "meter", NO_ALTERNATE), ("meters", "meters", NO_ALTERNATE),
                ("foot", "foot", NO_ALTERNATE), ("feet", "feet", NO_ALTERNATE),
                ("degree celsius", "degc", NO_ALTERNATE), ("degrees celsius", "degsc", NO_ALTERNATE),
                ("degree fahrenheit", "degf", NO_ALTERNATE), ("degrees fahrenheit", "degsf", NO_ALTERNATE),
                ("percent", "percent", NO_ALTERNATE),
                ("milliamp-hour", "mamph", NO_ALTERNATE), ("milliamp-hours", "mamphs", NO_ALTERNATE),
                ("watt", "watt", NO_ALTERNATE), ("watts", "watts", NO_ALTERNATE),
                ("milli-watt", "mwatt", NO_ALTERNATE), ("milli-watts", "mwatts", NO_ALTERNATE),
                ("db", "db", NO_ALTERNATE),
                ("r p m", "rpm", NO_ALTERNATE),
                ("g", "g", NO_ALTERNATE),
                ("degree", "degree", NO_ALTERNATE), ("degrees", "degrees", NO_ALTERNATE),
                ("radian", "rad", NO_ALTERNATE), ("radians", "rads", NO_ALTERNATE),
                ("milliliter", "mm", NO_ALTERNATE), ("milliliters", "mms", NO_ALTERNATE),
                ("fluid ounce", "founce", NO_ALTERNATE), ("fluid ounces", "founces", NO_ALTERNATE),
                ("hour", "hour", NO_ALTERNATE), ("hours", "hours", NO_ALTERNATE),
                ("minute", "minute", NO_ALTERNATE), ("minutes", "minutes", NO_ALTERNATE),
                ("second", "second", NO_ALTERNATE), ("seconds", "seconds", NO_ALTERNATE),
                       ]:
