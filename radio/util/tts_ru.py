...
for i, (s, f) in enumerate([
                            ...
                            (u"Двигатели выключены", "disarmed"),
                            ...
                            (u"Режим,акро", "fm-acro"),
                            (u"Режим круиза", "fm-crs"),
                            (u"Режим взлета", "fm-lch"),
                            (u"Режим посадки", "fm-lnd"),
                            (u"Нормальный режим", "fm-nrm"),
                            (u"Ручной режим", "fm-man"),
                            (u"Стабилизация", "fm-stab"),
                            (u"Удержание позиции", "fm-phold"),
                            (u"Возврат в точку старта", "fm-rth"),
                            (u"Горизонт", "fm-horizon"),
                            (u"Стабилизация", "fm-angle"),
                            (u"аирмод включен", "airm-on"),
                            (u"аирмод выключен", "airm-off"),
                            (u"Высота", "altitude"),
                            (u"Удержание высоты", "alt-hold"),
                            (u"Критический разряд!", "batcrit"),
                            (u"Время полета", "flt-time"),
                            (u"Аварийный режим выключен", "fsoff"),
                            (u"Аварийный режим включен", "fson"),
                            (u"ДжиПи Эс", "gps"),
                            (u"Высокие расходы", "hirates"),
                            (u"Низкие расходы", "lowrates"),
                            (u"Спутники найдены!", "sats-fix"),
                            (u"Спутники потеряны!", "sats-lost"),
                            (u"Бортовые огни выключены", "led-off"),
                            (u"Бортовые огни включены", "led-on")
                            ]):
