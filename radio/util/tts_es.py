...
for s, f, a in [(u"Voltio","volt0", NO_ALTERNATE),  
             ...
             (u"metros por segundo", "mps0", NO_ALTERNATE),
             (u"pie por segundo", "fps0", NO_ALTERNATE),
             (u"kilómetro por hora", "kph0", NO_ALTERNATE),
             (u"millas por hora", "mph0", NO_ALTERNATE),
             (u"metros", "meter0", NO_ALTERNATE),
             (u"pie", "foot0", NO_ALTERNATE),
             (u"grados", "celsius0", NO_ALTERNATE),
             (u"fahrenheit", "fahr0", NO_ALTERNATE),
             (u"por ciento", "percent0", NO_ALTERNATE),
             (u"miliamperios por hora", "mamph0", NO_ALTERNATE),
             (u"vatio", "watt0", NO_ALTERNATE),
             (u"millivatio", "mwatt0", NO_ALTERNATE),
             (u"db", "db0", NO_ALTERNATE),
             (u"RPM", "rpm0", NO_ALTERNATE),
             (u"g", "g0", NO_ALTERNATE),
             (u"grados", "degree0", NO_ALTERNATE),
             (u"radianes ", "rad0", NO_ALTERNATE),
             (u"mililitro", "ml0", NO_ALTERNATE),
             (u"onzas", "founce0", NO_ALTERNATE),
